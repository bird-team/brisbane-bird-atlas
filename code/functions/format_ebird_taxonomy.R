...
format_ebird_taxonomy <- function(x, scientific_column_name,
  ...
  data.table::setnames(x,
                       c(scientific_column_name, family_column_name,
                         order_column_name),
                       c("species_scientific_name", "family",
  ...
  x <- x[, c("species_scientific_name", "family_scientific_name",
             "family_common_name", "order_scientific_name"), drop = FALSE]
