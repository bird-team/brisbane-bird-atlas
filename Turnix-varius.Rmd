...
Category A; Rare widespread resident.

```{r}
render_species_profile(species_name, caption = "Photo by Louis Backstrom, Enoggera Reservoir, 1 Jul 2018")
```
