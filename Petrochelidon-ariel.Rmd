```{r, include=FALSE}
species_name <- "Petrochelidon ariel"
```
...
Category A; Common widespread partial summer migrant.

```{r}
render_species_profile(species_name, caption = "Photo by Louis Backstrom, Kedron Brook Wetlands, 15 May 2018")
```
