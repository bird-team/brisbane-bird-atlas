```{r, include=FALSE}
species_name <- "Anthus novaeseelandiae"
```
...
Category A; Common localised resident.

```{r}
render_species_profile(species_name, caption = "Photo by Louis Backstrom, Kedron Brook Wetlands, 1 Mar 2018")
```
