```{r, include=FALSE}
species_name <- "Taeniopygia bichenovii"
```
...
Category A; Moderately common widespread partial winter migrant.

```{r}
render_species_profile(species_name, caption = "Photo by Louis Backstrom, Oxley Creek Common, 11 Jan 2018")
```
