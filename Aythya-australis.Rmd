...
```{r}
render_species_profile(species_name, caption = "Common and widespread resident and perhaps partial winter migrant to wetlands and lakes across Brisbane. Not of conservatin concern, although abundance year-to-year fluctuates, indicating that birds may be partially nomadic.")
```
