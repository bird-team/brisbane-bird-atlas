...
Category A; Moderately common widespread winter migrant.

```{r}
render_species_profile(species_name, caption = "Photo by Louis Backstrom, Shelley Rd Park, 17 May 2018")
```
