```{r, include=FALSE}
species_name <- "Cacomantis flabelliformis"
```
...
Category A; Common widespread winter migrant.

```{r}
render_species_profile(species_name, caption = "Photo by Louis Backstrom, Oxley Creek Common, 23 Jul 2018")
```
