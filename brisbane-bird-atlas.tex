...
Threat status & Brisbane status\\
\midrule
\textit{IUCN:} Least Concern & \textit{eBird records:} 464\\
\textit{National:} Not listed & \textit{Atlas squares:} 30\\
...
Threat status & Brisbane status\\
\midrule
\textit{IUCN:} Least Concern & \textit{eBird records:} 1,719\\
\textit{National:} Not threatened; Marine & \textit{Atlas squares:} 27\\
\textit{Queensland:} Not listed & \textit{Reporting rate:} 6\%\\
\bottomrule
\end{tabu} 
\vspace{0.15cm}
...
Threat status & Brisbane status\\
\midrule
\textit{IUCN:} Least Concern & \textit{eBird records:} 575\\
...
\textit{National:} Not listed & \textit{Atlas squares:} 41\\
...
Threat status & Brisbane status\\
\midrule
\textit{IUCN:} Least Concern & \textit{eBird records:} 24\\
\textit{National:} Not threatened; Marine & \textit{Atlas squares:} 4\\
...
Threat status & Brisbane status\\
\midrule
\textit{IUCN:} Least Concern & \textit{eBird records:} 5,312\\
\textit{National:} Not listed & \textit{Atlas squares:} 84\\
\textit{Queensland:} Not listed & \textit{Reporting rate:} 15\%\\
\bottomrule
\end{tabu} 
\vspace{0.15cm}
...
Threat status & Brisbane status\\
\midrule
\textit{IUCN:} Least Concern & \textit{eBird records:} 214\\
\textit{National:} Not listed & \textit{Atlas squares:} 12\\
\textit{Queensland:} Not listed & \textit{Reporting rate:} 1\%\\
\bottomrule
\end{tabu} 
\vspace{0.15cm}
...
Threat status & Brisbane status\\
\midrule
\textit{IUCN:} Least Concern & \textit{eBird records:} 13,080\\
\textit{National:} Not listed & \textit{Atlas squares:} 217\\
\textit{Queensland:} Not listed & \textit{Reporting rate:} 41\%\\
\bottomrule
\end{tabu} 
\vspace{0.15cm}
...
Threat status & Brisbane status\\
\midrule
\textit{IUCN:} Least Concern & \textit{eBird records:} 4,031\\
\textit{National:} Not listed & \textit{Atlas squares:} 56\\
\textit{Queensland:} Not listed & \textit{Reporting rate:} 12\%\\
\bottomrule
\end{tabu} 
\vspace{0.15cm}
...
Threat status & Brisbane status\\
\midrule
\textit{IUCN:} Least Concern & \textit{eBird records:} 3,065\\
\textit{National:} Not listed & \textit{Atlas squares:} 43\\
...
Threat status & Brisbane status\\
\midrule
\textit{IUCN:} Least Concern & \textit{eBird records:} 114\\
\textit{National:} Not listed & \textit{Atlas squares:} 7\\
\textit{Queensland:} Not listed & \textit{Reporting rate:} 0\%\\
\bottomrule
\end{tabu} 
\vspace{0.15cm}
...
Threat status & Brisbane status\\
\midrule
\textit{IUCN:} Least Concern & \textit{eBird records:} 88\\
\textit{National:} Not threatened; Marine & \textit{Atlas squares:} 1\\
\textit{Queensland:} Not listed & \textit{Reporting rate:} 0\%\\
\bottomrule
\end{tabu} 
\vspace{0.15cm}
