...
\midrule
\textit{IUCN:} Least Concern & \textit{eBird records:} 1,691\\
\textit{National:} Marine, not threatened & \textit{Atlas squares:} 42\\
...
Threat status & Brisbane status\\
\midrule
\textit{IUCN:} TODO & \textit{eBird records:} 1,570\\
...
Threat status & Brisbane status\\
\midrule
\textit{IUCN:} TODO & \textit{eBird records:} 496\\
...
Threat status & Brisbane status\\
\midrule
\textit{IUCN:} TODO & \textit{eBird records:} 1,722\\
\textit{National:} TODO & \textit{Atlas squares:} 48\\
...
Threat status & Brisbane status\\
\midrule
\textit{IUCN:} TODO & \textit{eBird records:} 4,696\\
\textit{National:} TODO & \textit{Atlas squares:} 77\\
\textit{Queensland:} TODO & \textit{Reporting rate:} 18\%\\
\bottomrule
\end{tabu} 
\vspace{0.15cm}
