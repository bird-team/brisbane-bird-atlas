```{r, include=FALSE}
species_name <- "Sternula albifrons"
```
...
Category A; Moderately common localised summer migrant.

```{r}
render_species_profile(species_name, caption = "Photo by Louis Backstrom, Nudgee Beach, 6 Nov 2018")
```
